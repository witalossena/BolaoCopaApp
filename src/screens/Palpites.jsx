  ...
  return (
    <div>
      ...
      <div className="mt-8 pt-6 border-t border-edge/40 flex flex-col sm:flex-row items-center justify-between gap-5">
        <p className="text-mute2 text-sm flex items-center gap-2 order-3 sm:order-1">
          {locked ? (
            <>
        ...
        <div className="flex flex-col sm:flex-row items-center gap-3 w-full sm:w-auto order-1 sm:order-2">
          <button onClick={handleShareWhatsApp}
            className="w-full sm:w-auto flex items-center justify-center gap-2 px-4 h-11 rounded-xl font-cond font-semibold text-sm border border-edge bg-surface2 text-cream hover:border-[#25D366] hover:text-[#25D366] transition">
